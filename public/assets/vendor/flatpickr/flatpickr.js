(function(){
    ...
    $('[data-toggle="flatpickr"]').each(function() {
      var element  = $(this);
      var classAdd = ''; 
      var parsley  = element.attr('data-parsley-required');
      
      if (parsley) {
        classAdd = ' add-parsley-validate';
      }
      ...
      var options = {
        ...
        altInputClass: void 0 !== element.data('flatpickr-alt-input-class') 
          ...
          : 'form-control flatpickr-input' + classAdd,
      ...
      $('.add-parsley-validate').attr('data-parsley-required', 'true');
    })
    
    $('[data-toggle="flatpickr"]').change(function (e) { 
      $('.add-parsley-validate').parsley().validate()
    });
  })()