    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 mx-auto  pt-5 mt-5">
                ...
                <h5 class="mb-4 text-center">Masukkan Domain Sekolahmu</h5>
                <div>
                ...
                <div class="card card-body">
                    <form class="px-5 py-5" action="{{ route('checkdomain') }}" novalidate method="POST">
                        @csrf
                        <label class="text-left" for="Password">Nama Domain</label>
                        <div class="input-group">
                            <input type="text" class="form-control {{ $errors->has('domain') ? 'is-invalid' : '' }} ?>"
                                name="domain" placeholder="Domain Sekolah" aria-label="Domain Sekolah"
                                aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <span class="input-group-text" id="basic-addon2">pijar.co.id</span>
                            </div>
                        ...
                        <div class="form-group text-center mb-0">
                            <small>
                                Sekolah kamu belum terdaftar? <a class="text-underline" href="/registration">Daftarkan
                                    Sekolah Kamu!</a>
                            </small>
                        </div>
                    </form>
