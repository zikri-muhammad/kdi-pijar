...
@section('content')
    ...
    <div class="row">
      <div class="col-md-6 mx-auto pt-5 mt-5">
				...
				<h5 class="mb-4 text-center">Masukkan Email <br>untuk melakukan aktivasi</h5>
				<div class="card card-body">
					{{-- <form class="mt-4" action="/activation/form" novalidate> --}}
					<form class="mt-4" action="{{ route('activation') }}" novalidate method="POST">
						@csrf
