        ...
        <div class="col-md-3">
          <div class="card">
            <div class="border-bottom">
              <div class="card-body text-center">
                <div class="mb-3">
                  <img src="{{ asset('assets/images/256_luke-porter-261779-unsplash.jpg') }}" alt="About Adrian" width="150" class="rounded-circle">
                </div>
                <p> {{ Session::get('users')['data']['name'] }} | mosi@myemail.com | XII IPA - A</p>
                <p> Short bio about this student is coming soon.</p>
              </div>
            </div>
            <div class="border-bottom">
              <div class="card-header bg-light">
                  <h4 class="card-header__title text-center">Pencapaian</h4>
              </div>
              <div class="card-body text-center">
                <div class="avatar avatar-xs mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="First Time Enroll Class">
                ...
                <div class="avatar avatar-xs mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="100 Lessons Learned">
                ...
                <div class="avatar avatar-xs mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="First Course Completed">
                ...
                <div class="avatar avatar-xs mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="1 Series Completed">
                ...
                <div class="avatar avatar-xs mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Rank 1 Student">
                    <span class="avatar-title rounded-circle bg-light-gray">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="20" height="20">
                            <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
          ...
          <div class="card card-body">
            <div class="d-flex align-items-center">
              ...
              <div>
                <a href="#" class="text-muted mb-2">NIS</a>
                <h4 class="m-0 bold">621241283</h4>
              </div>
            </div>
          </div>
          ...
          <!-- <div class="card card-body">
            <div class="d-flex align-items-center">
              ...
              <div>
                <a href="#" class="text-muted mb-2">Jumlah Mapel</a>
          ...
          <div class="card card-body">
            <div class="d-flex align-items-center">
              ...
              <div>
                <a href="#" class="text-muted mb-2">Tingkat Kelas</a>
                <h4 class="m-0 bold">XII IPA - A</h4>
              </div>
            </div>
          </div>
