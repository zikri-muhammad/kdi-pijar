...
@section('content')
    ...
    <div class="row">
      <div class="col-md-6 mx-auto pt-5 mt-5">
				...
				<h5 class="mb-4 text-center">Masukkan Nomor Lisensi PIJAR</h5>
				<div>
				...
				<div class="card card-body">
					<p><strong class="headings-color">Cara mendapatkan nomor lisensi</strong></p>
					<p>
						1. Buka Aplikasi blilbi.com<br>
						2. Beli produk lisensi PIJAR<br>
						3. Lorem ipsum dolor sit amet<br>
					</p>
					<form class="mt-4" action="{{ route('registration.store') }}" novalidate method="GET">
						@csrf
						<div class="form-group">
							<label for="exampleInputEmail1">Nomor Lisensi:</label>
							<input type="text" name="nomor_lisensi" class="form-control" placeholder="Masukkan Nomor Lisensi">
						</div>
						<div class="form-group text-center">
							<button type="submit" class="btn btn-primary px-5">Aktivasi</button>
						</div>
						<div class="form-group text-center mb-0">
							<small>
								Sudah terdaftar? <a class="text-underline" href="/login">Login Sekarang</a>
							</small>
						</div>
					</form>		
				</div>
