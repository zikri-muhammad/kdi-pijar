    ...
    <div class="mdk-drawer-layout__content page">
        ...
        <div class="container-fluid page__heading-container">
            <div
                ...
                <h1 class="m-lg-0">{{ Session::get('users')['data']['name'] }} Dashboard</h1>
            </div>
        </div>
        <!-- content              -->
        <div class="container-fluid page__container">
            <div class="alert alert-soft-warning d-flex align-items-center card-margin p-2" role="alert">
                ...
                <div class="text-body">Anda mempunyai <strong>1 tugas</strong> yang belum di selesaikan</div>
                <a href="" class="btn btn-warning ml-auto">Lihat</a>
            </div>
            <h4 class="card-header__title mb-3">Progress Belajar Mandiri</h4>
            <div class="row card-group-row mb-4">
                <div class="col card-group-row__col">
                    <div class="card card-group-row__card ">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="flex">
                                <a href="#" class="text-body"><strong>Matematika</strong></a>
                                <div class="d-flex align-items-center">
                                    <div class="progress" style="width: 100%; height:4px;">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 40%"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <small class="text-muted ml-2">40%</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col card-group-row__col">
                    <div class="card card-group-row__card ">
                        <div class="card-body d-flex align-items-center">
                            <a href="#" class="mr-3">
                                <img src="{{ asset('assets/images/logos/react.svg') }}" alt="course" class="" width="34px"
                                    height="34px">
                            </a>
                            <div class="flex">
                                <a href="#" class="text-body"><strong>Bahasa Inggris</strong></a>
                                <div class="d-flex align-items-center">
                                    <div class="progress" style="width: 100%; height:4px;">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 70%"
                                            aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <small class="text-muted ml-2">70%</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col card-group-row__col">
                    <div class="card card-group-row__card ">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="flex">
                                <a href="#" class="text-body"><strong>Kimia</strong></a>
                                <div class="d-flex align-items-center">
                                    <div class="progress" style="width: 100%; height:4px;">
                ...
                <div class="col card-group-row__col">
                    <div class="card card-group-row__card ">
                        <div class="card-body d-flex align-items-center">
                            <a href="#" class="mr-3">
                                <img src="{{ asset('assets/images/logos/vuejs.svg') }}" alt="course" class="" width="34px"
                                    height="34px">
                            </a>
                            <div class="flex">
                                <a href="#" class="text-body"><strong>Biologi</strong></a>
                                <div class="d-flex align-items-center">
                                    <div class="progress" style="width: 100%; height:4px;">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 90%"
                                            aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <small class="text-muted ml-2">90%</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col card-group-row__col">
                    <div class="card card-group-row__card ">
                        <div class="card-body d-flex align-items-center justify-content-center">
                            <a href="#" class="text-body"><strong>View More</strong></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="list-group list-group-flush mb-0" style="z-index: initial;">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="#" class="mr-3">
                                        <span class="avatar avatar-sm mr-2">
                                            <span
                                                class="avatar-title rounded-circle bg-soft-secondary text-muted">XII</span>
                                        </span>
                                    </a>
                                    <div class="flex">
                                        <a href="#" class="text-body d-block"><strong>Kelas XII IPA B</strong></a>
                            ...
                            <li class="list-group-item" style="z-index: initial;">
                                <div class="d-flex align-items-center">
                                    <a href="#" class="mr-3">
                                        <span class="avatar avatar-sm mr-2">
                                            <span class="avatar-title rounded-circle bg-soft-secondary text-muted">XI</span>
                                        </span>
                                    </a>
                                    <div class="flex">
                                        <a href="#" class="text-body d-block"><strong>Kelas XI IPS A</strong></a>
                                        <small class="text-muted">
                            ...
                            <li class="list-group-item" style="z-index: initial;">
                                <div class="d-flex align-items-center">
                                    <a href="#" class="mr-3">
                                        <span class="avatar avatar-sm mr-2">
                                            <span class="avatar-title rounded-circle bg-soft-secondary text-muted">IX</span>
                                        </span>
                                    </a>
                                    <div class="flex">
                                        <a href="#" class="text-body d-block"><strong>Kelas IX IPA B</strong></a>
                                        <small class="text-muted">
                                            Sesi Kelas Biologi akan dimulai dalam
                                            <span class="text-warning">02:22:00</span>
                                        </small>
                            ...
                            <li class="list-group-item">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <a class="text-body mb-1" href="#"><strong>Bab 1 Perkembang Biakan
                                                Hewan</strong></a><br>
                                        <div class="d-flex align-items-center">
